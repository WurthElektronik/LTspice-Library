...
SYMATTR Description WE-MXGA SMT Power Inductor \nAfter inserting, right-click on the symbol to select the part number. \nwww.we-online.com/components/products/WE-MXGA \n\nPlease note disclaimer in WE-MXGA.lib.
SYMATTR InstName L
SYMATTR SpiceModel 4020_78438440200016_0.16u
SYMATTR Prefix x
SYMATTR ModelFile WE-MXGA.lib
PIN -48 0 NONE 8
PINATTR PinName 1
