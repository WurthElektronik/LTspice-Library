...
SYMATTR Description WE-XHMA SMD Power Inductor \nAfter inserting, right-click on the symbol to select the part number. \nwww.we-online.com/en/components/products/WE-XHMA \n\nPlease note disclaimer in WE-XHMA.lib.
SYMATTR InstName L
SYMATTR SpiceModel 1090_78439369022_2.2u
SYMATTR Prefix x
SYMATTR ModelFile WE-XHMA.lib
PIN -48 0 NONE 8
PINATTR PinName 1
