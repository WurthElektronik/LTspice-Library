...
SYMATTR Description WE-HCIA SMD Flat Wire High Current Inductor \nAfter inserting, right-click on the symbol to select the part number. \nwww.we-online.com/catalog/WE_HCIA \n\nPlease note disclaimer in WE-HCIA.lib.
SYMATTR SpiceModel 1050_7843250072_0.72u
SYMATTR Prefix x
SYMATTR InstName L
SYMATTR ModelFile WE-HCIA.lib
PIN -48 0 NONE 8
PINATTR PinName 1
