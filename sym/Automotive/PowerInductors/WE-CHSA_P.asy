...
SYMATTR Description WE-CHSA P Performance SMT High Current Inductor \nAfter inserting, right-click on the symbol to select the part number. \nwww.we-online.com/catalog/WE_CHSA_P \n\nPlease note disclaimer in WE-CHSA_P.lib.
SYMATTR InstName L
SYMATTR SpiceModel 1011_78433390150_1.5u
SYMATTR Prefix x
SYMATTR ModelFile WE-CHSA_P.lib
PIN -48 0 NONE 8
PINATTR PinName 1
