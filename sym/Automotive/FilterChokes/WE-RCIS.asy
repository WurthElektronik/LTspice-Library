...
SYMATTR Description WE-RCIS Rod Core Inductor SMT \nAfter inserting, right-click on the symbol to select the part number. \nwww.we-online.com/components/products/WE-RCIS \n\nPlease note disclaimer in WE-RCIS.lib.
SYMATTR InstName L
SYMATTR SpiceModel 7847227010_1u
SYMATTR Prefix x
SYMATTR ModelFile WE-RCIS.lib
PIN -48 0 NONE 8
PINATTR PinName 1
