...
SYMATTR Description WE-RCIT Rod Core Inductor THT \nAfter inserting, right-click on the symbol to select the part number. \nwww.we-online.com/catalog/WE-RCIT \n\nPlease note disclaimer in WE-RCIT.lib.
SYMATTR InstName L
SYMATTR SpiceModel 7847110020_2u
SYMATTR Prefix x
SYMATTR ModelFile WE-RCIT.lib
PIN -48 0 NONE 8
PINATTR PinName 1
