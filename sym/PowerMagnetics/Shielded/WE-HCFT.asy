...
SYMATTR Description WE-HCFT THT High Current Inductor \nAfter inserting, right-click on the symbol to select the part number. \nwww.we-online.com/en/components/products/WE-HCFT \n\nPlease note disclaimer in WE-HCFT.lib.
SYMATTR InstName L
SYMATTR SpiceModel 2504_7443762504010_1u
SYMATTR Prefix x
SYMATTR ModelFile WE-HCFT.lib
PIN -48 0 NONE 8
PINATTR PinName 1
