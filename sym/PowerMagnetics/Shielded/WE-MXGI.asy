...
SYMATTR Description WE-MXGI SMT Power Inductor \nAfter inserting, right-click on the symbol to select the part number. \nwww.we-online.com/en/components/products/WE-MXGI \n\nPlease note disclaimer in WE-MXGI.lib.
SYMATTR InstName L
SYMATTR SpiceModel 4020_74438440200016_0.16u
SYMATTR Prefix x
SYMATTR ModelFile WE-MXGI.lib
PIN -48 0 NONE 8
PINATTR PinName 1
