...
SYMATTR Description WE-HEPC SMT Power Inductor \nAfter inserting, right-click on the symbol to select the part number. \nwww.we-online.com/catalog/WE-HEPC \n\nPlease note disclaimer in WE-HEPC.lib.
SYMATTR InstName L
SYMATTR SpiceModel 5030_74408053003_3.3u
SYMATTR Prefix x
SYMATTR ModelFile WE-HEPC.lib
PIN -48 0 NONE 8
PINATTR PinName 1
