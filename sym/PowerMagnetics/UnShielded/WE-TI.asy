...
SYMATTR Description WE-TI Radial Leaded Wire Wound Inductor \nAfter inserting, right-click on the symbol to select the part number. \nwww.we-online.com/components/products/WE-TI \n\nPlease note disclaimer in WE-TI.lib.
SYMATTR InstName L
SYMATTR SpiceModel 1014_7447480680_68u
SYMATTR Prefix x
