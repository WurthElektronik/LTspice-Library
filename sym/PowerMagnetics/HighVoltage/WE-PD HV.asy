...
SYMATTR Description WE-PD HV SMT Power Inductor (High Voltage) \nAfter inserting, right-click on the symbol to select the part number. \nwww.we-online.com/en/components/products/WE-PD-HV \n\nPlease note disclaimer in WE-PD HV.lib.
SYMATTR InstName L
SYMATTR SpiceModel 1040_7687719821_820u
SYMATTR Prefix x
SYMATTR ModelFile WE-PD HV.lib
PIN -48 0 NONE 8
PINATTR PinName 1
