...
SYMATTR Description WE-TI HV Radial Leaded Wire Wound Inductor (High Voltage) \nAfter inserting, right-click on the symbol to select the part number. \nhttps://www.we-online.com/catalog/en/WE-TI-HV \n\nPlease note disclaimer in WE-TI HV.lib.
SYMATTR SpiceModel 8095_768772332_3300u
SYMATTR Prefix x
SYMATTR InstName L
SYMATTR ModelFile WE-TI HV.lib
PIN -48 0 NONE 8
PINATTR PinName 1
