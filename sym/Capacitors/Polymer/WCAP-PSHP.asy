...
SYMATTR Description WCAP-PSHP Aluminum Polymer Capacitors \nAfter inserting, right-click on the symbol to select the part number. \nwww.we-online.com/catalog/WCAP-PSHP \n\nPlease note disclaimer in WCAP-PSHP.lib.
SYMATTR InstName C
SYMATTR SpiceModel 875115150001_220uF
SYMATTR Prefix x
SYMATTR ModelFile WCAP-PSHP.lib
PIN -32 0 NONE 8
PINATTR PinName 1
