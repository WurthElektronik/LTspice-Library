...
SYMATTR Description WCAP-HSAH Aluminum Hybrid Polymer Capacitors \nAfter inserting, right-click on the symbol to select the part number. \nwww.we-online.com/components/products/WCAP-HSAH \n\nPlease note disclaimer in WCAP-HSAH.lib.
SYMATTR InstName C
SYMATTR SpiceModel 875585559001_33uF
SYMATTR Prefix x
SYMATTR ModelFile WCAP-HSAH.lib
PIN -32 0 NONE 8
PINATTR PinName 1
