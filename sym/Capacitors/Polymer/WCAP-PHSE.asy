...
SYMATTR Description WCAP-PHSE Aluminum Polymer Capacitors \nAfter inserting, right-click on the symbol to select the part number. \nwww.we-online.com/catalog/WCAP-PHSE \n\nPlease note disclaimer in WCAP-PHSE.lib.
SYMATTR InstName C
SYMATTR SpiceModel 875046219001_330uF
SYMATTR Prefix x
SYMATTR ModelFile WCAP-PHSE.lib
PIN -32 0 NONE 8
PINATTR PinName 1
