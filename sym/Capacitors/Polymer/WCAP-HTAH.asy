...
SYMATTR Description WCAP-HTAH Aluminum Hybrid Polymer Capacitors \nAfter inserting, right-click on the symbol to select the part number. \nwww.we-online.com/en/components/products/WCAP-HTAH \n\nPlease note disclaimer in WCAP-HTAH.lib.
SYMATTR InstName C
SYMATTR SpiceModel 870585373001_120uF
SYMATTR Prefix x
SYMATTR ModelFile WCAP-HTAH.lib
PIN -32 0 NONE 8
PINATTR PinName 1
