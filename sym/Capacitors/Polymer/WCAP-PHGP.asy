...
SYMATTR Description WCAP-PHGP Aluminum Polymer Capacitors \nAfter inserting, right-click on the symbol to select the part number. \nwww.we-online.com/catalog/WCAP-PHGP \n\nPlease note disclaimer in WCAP-PHGP.lib.
SYMATTR InstName C
SYMATTR SpiceModel 875015019003_180uF
SYMATTR Prefix x
SYMATTR ModelFile WCAP-PHGP.lib
PIN -32 0 NONE 8
PINATTR PinName 1
