...
SYMATTR Description WCAP-HTG5 Aluminum Hybrid Polymer Capacitors \nAfter inserting, right-click on the symbol to select the part number. \nwww.we-online.com/en/components/products/WCAP-HTG5 \n\nPlease note disclaimer in WCAP-HTG5.lib.
SYMATTR InstName C
SYMATTR SpiceModel 870575373001_120uF
SYMATTR Prefix x
SYMATTR ModelFile WCAP-HTG5.lib
PIN -32 0 NONE 8
PINATTR PinName 1
