...
SYMATTR Description WCAP-PTG5 Aluminum Polymer Capacitors \nAfter inserting, right-click on the symbol to select the part number. \nwww.we-online.com/catalog/WCAP-PTG5 \n\nPlease note disclaimer in WCAP-PTG5.lib.
SYMATTR InstName C
SYMATTR SpiceModel 870025174001_180uF
SYMATTR Prefix x
SYMATTR ModelFile WCAP-PTG5.lib
PIN -32 0 NONE 8
PINATTR PinName 1
