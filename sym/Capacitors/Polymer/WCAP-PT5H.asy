...
SYMATTR Description WCAP-PT5H Aluminum Polymer Capacitors \nAfter inserting, right-click on the symbol to select the part number. \nwww.we-online.com/catalog/WCAP-PT5H \n\nPlease note disclaimer in WCAP-PT5H.lib.
SYMATTR InstName C
SYMATTR SpiceModel 870235174001_390uF
SYMATTR Prefix x
SYMATTR ModelFile WCAP-PT5H.lib
PIN -32 0 NONE 8
PINATTR PinName 1
