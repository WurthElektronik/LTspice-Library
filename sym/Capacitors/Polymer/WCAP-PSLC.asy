...
SYMATTR Description WCAP-PSLC Aluminum Polymer Capacitors \nAfter inserting, right-click on the symbol to select the part number. \nwww.we-online.com/catalog/WCAP-PSLC \n\nPlease note disclaimer in WCAP-PSLC.lib.
SYMATTR InstName C
SYMATTR SpiceModel 875075155001_180uF
SYMATTR Prefix x
SYMATTR ModelFile WCAP-PSLC.lib
PIN -32 0 NONE 8
PINATTR PinName 1
