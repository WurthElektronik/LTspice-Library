...
SYMATTR Description WCAP-PTHT Aluminum Polymer Capacitors \nAfter inserting, right-click on the symbol to select the part number. \nwww.we-online.com/catalog/WCAP-PTHT \n\nPlease note disclaimer in WCAP-PTHT.lib.
SYMATTR InstName C
SYMATTR SpiceModel 870135174001_390uF
SYMATTR Prefix x
SYMATTR ModelFile WCAP-PTHT.lib
PIN -32 0 NONE 8
PINATTR PinName 1
