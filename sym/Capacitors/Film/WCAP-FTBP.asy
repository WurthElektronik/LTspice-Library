...
SYMATTR Description WCAP-FTBP Film Capacitors \nAfter inserting, right-click on the symbol to select the part number. \nwww.we-online.com/catalog/WCAP-FTBP \n\nPlease note disclaimer in WCAP-FTBP.lib.
SYMATTR InstName C
SYMATTR SpiceModel 890273322005CS_150nF
SYMATTR Prefix x
SYMATTR ModelFile WCAP-FTBP.lib
PIN -32 0 NONE 8
PINATTR PinName 1
