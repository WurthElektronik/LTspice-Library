...
SYMATTR Description WCAP-FTY2 Film Capacitors \nAfter inserting, right-click on the symbol to select the part number. \nwww.we-online.com/components/products/WCAP-FTY2 \n\nPlease note disclaimer in WCAP-FTY2.lib.
SYMATTR InstName C
SYMATTR SpiceModel 890404123001CS_1nF
SYMATTR Prefix x
SYMATTR ModelFile WCAP-FTY2.lib
PIN -32 0 NONE 8
PINATTR PinName 1
