...
SYMATTR Description WCAP-FTBE Film Capacitors \nAfter inserting, right-click on the symbol to select the part number. \nwww.we-online.com/catalog/WCAP-FTBE \n\nPlease note disclaimer in WCAP-FTBE.lib.
SYMATTR InstName C
SYMATTR SpiceModel 890263425004CS_2.2uF
SYMATTR Prefix x
SYMATTR ModelFile WCAP-FTBE.lib
PIN -32 0 NONE 8
PINATTR PinName 1
