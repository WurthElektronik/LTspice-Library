...
SYMATTR Description SYMATTR Description WCAP-AWG8 Aluminum Electrolytic Capacitors \nAfter inserting, right-click on the symbol to select the part number. \n\nwww.we-online.com/components/products/WCAP-AWG8_SCREW
SYMATTR Prefix x
SYMATTR InstName C
SYMATTR SpiceModel 862011291005_8.2mF
SYMATTR ModelFile WCAP-AWG8.lib
PIN -32 0 NONE 8
PINATTR PinName 1
