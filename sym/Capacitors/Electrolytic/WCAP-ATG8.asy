...
SYMATTR Description WCAP-ATG8 Aluminum Electrolytic Capacitors \nAfter inserting, right-click on the symbol to select the part number. \nwww.we-online.com/catalog/WCAP-ATG8 \n\nPlease note disclaimer in WCAP-ATG8.lib.
SYMATTR InstName C
SYMATTR SpiceModel 860010272001_22uF
SYMATTR Prefix x
SYMATTR ModelFile WCAP-ATG8.lib
PIN -32 0 NONE 8
PINATTR PinName 1
