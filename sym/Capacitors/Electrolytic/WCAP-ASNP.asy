...
SYMATTR Description WCAP-ASNP Aluminum Electrolytic Capacitors \nAfter inserting, right-click on the symbol to select the part number. \nwww.we-online.com/catalog/WCAP-ASNP \n\nPlease note disclaimer in WCAP-ASNP.lib.
SYMATTR InstName C
SYMATTR SpiceModel 865250140001_10uF
SYMATTR Prefix x
SYMATTR ModelFile WCAP-ASNP.lib
PIN -32 0 NONE 8
PINATTR PinName 1
