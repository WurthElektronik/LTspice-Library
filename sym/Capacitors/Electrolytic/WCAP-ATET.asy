...
SYMATTR Description WCAP-ATET Aluminum Electrolytic Capacitors \nAfter inserting, right-click on the symbol to select the part number. \nwww.we-online.com/catalog/WCAP-ATET \n\nPlease note disclaimer in WCAP-ATET.lib.
SYMATTR InstName C
SYMATTR SpiceModel 860130272001_47uF
SYMATTR Prefix x
SYMATTR ModelFile WCAP-ATET.lib
PIN -32 0 NONE 8
PINATTR PinName 1
