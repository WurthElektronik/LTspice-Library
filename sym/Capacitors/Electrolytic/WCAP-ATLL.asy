...
SYMATTR Description WCAP-ATLL Aluminum Electrolytic Capacitors \nAfter inserting, right-click on the symbol to select the part number. \nwww.we-online.com/catalog/WCAP-ATLL \n\nPlease note disclaimer in WCAP-ATLL.lib.
SYMATTR InstName C
SYMATTR SpiceModel 860160272001_22uF
SYMATTR Prefix x
SYMATTR ModelFile WCAP-ATLL.lib
PIN -32 0 NONE 8
PINATTR PinName 1
