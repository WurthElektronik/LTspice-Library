...
SYMATTR Description WCAP-ATLI Aluminum Electrolytic Capacitors \nAfter inserting, right-click on the symbol to select the part number. \nwww.we-online.com/catalog/WCAP-ATLI \n\nPlease note disclaimer in WCAP-ATLI.lib.
SYMATTR InstName C
SYMATTR SpiceModel 860080272001_68uF
SYMATTR Prefix x
SYMATTR ModelFile WCAP-ATLI.lib
PIN -32 0 NONE 8
PINATTR PinName 1
