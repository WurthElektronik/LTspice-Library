...
SYMATTR Description SYMATTR Description WCAP-ASLU Aluminum Electrolytic Capacitors \nAfter inserting, right-click on the symbol to select the part number. \n\nhttps://www.we-online.com/catalog/en/WCAP-ASLU
SYMATTR Prefix x
SYMATTR InstName C
SYMATTR SpiceModel 865090140001_10uF
SYMATTR ModelFile WCAP-ASLU.lib
PIN -32 0 NONE 8
PINATTR PinName 1
