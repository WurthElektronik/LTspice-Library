...
SYMATTR Description SYMATTR Description WCAP-AWG5 Aluminum Electrolytic Capacitors \nAfter inserting, right-click on the symbol to select the part number. \n\nwww.we-online.com/components/products/WCAP-AWG5_SCREW_CAPACITOR
SYMATTR Prefix x
SYMATTR InstName C
SYMATTR SpiceModel 862023186001_1.6mF
SYMATTR ModelFile WCAP-AWG5.lib
PIN -32 0 NONE 8
PINATTR PinName 1
