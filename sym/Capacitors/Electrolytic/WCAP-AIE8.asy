...
SYMATTR Description WCAP-AIE8 Aluminum Electrolytic Capacitors \nAfter inserting, right-click on the symbol to select the part number. \nwww.we-online.com/catalog/WCAP-AIE8 \n\nPlease note disclaimer in WCAP-AIE8.lib.
SYMATTR InstName C
SYMATTR SpiceModel 861220784007_3.3mF
SYMATTR Prefix x
SYMATTR ModelFile WCAP-AIE8.lib
PIN -32 0 NONE 8
PINATTR PinName 1
