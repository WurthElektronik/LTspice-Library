...
SYMATTR Description WCAP-ASLL Aluminum Electrolytic Capacitors \nAfter inserting, right-click on the symbol to select the part number. \nwww.we-online.com/catalog/WCAP-ASLL \n\nPlease note disclaimer in WCAP-ASLL.lib.
SYMATTR InstName C
SYMATTR SpiceModel 865060140001_22uF
SYMATTR Prefix x
SYMATTR ModelFile WCAP-ASLL.lib
PIN -32 0 NONE 8
PINATTR PinName 1
