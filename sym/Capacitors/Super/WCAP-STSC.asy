...
SYMATTR Description WCAP-STSC Supercapacitors (EDLCs) \nAfter inserting, right-click on the symbol to select the part number. \nwww.we-online.com/catalog/WCAP-STSC \n\nPlease note disclaimer in WCAP-STSC.lib.
SYMATTR InstName C
SYMATTR SpiceModel 850617021001_5F
SYMATTR Prefix x
SYMATTR ModelFile WCAP-STSC.lib
PIN -32 0 NONE 8
PINATTR PinName 1
