...
SYMATTR Description WE-FI Leaded Toroidal Line Choke \nAfter inserting, right-click on the symbol to select the part number. \nwww.we-online.com/catalog/WE-FI \n\nPlease note disclaimer in WE-FI.lib.
SYMATTR SpiceModel 7447010_470u
SYMATTR Prefix x
SYMATTR InstName L
SYMATTR ModelFile WE-FI.lib
PIN -48 0 NONE 8
PINATTR PinName 1
