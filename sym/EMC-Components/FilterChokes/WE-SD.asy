...
SYMATTR Description WE-SD Rod Core Choke \nAfter inserting, right-click on the symbol to select the part number. \nwww.we-online.com/catalog/WE-SD \n\nPlease note disclaimer in WE-SD.lib.
SYMATTR InstName L
SYMATTR SpiceModel 744710203_2u
SYMATTR Prefix x
SYMATTR ModelFile WE-SD.lib
PIN -48 0 NONE 8
PINATTR PinName 1
